      ...
      <Container maxWidth="lg">
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Typography variant="body2">
              Email:{' '}
              <Link href="mailto:2023506074@student.annauniv.edu" color="inherit" sx={{ textDecoration: 'underline', '&:hover': { color: '#f57c00' } }}>
                2023506074@student.annauniv.edu
              </Link>
            </Typography>
            <Typography variant="body2" sx={{ marginTop: '0.5rem' }}>
              Address: Madras Institute of Technology,Anna University, Chennai, Tamil Nadu, India
            </Typography>
          </Grid>
        </Grid>
